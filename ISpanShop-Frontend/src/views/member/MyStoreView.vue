  ...
  <div class="my-store-container">
    <div class="page-header">
      ...
      <div class="header-right">
        <el-button v-if="status === 'Approved'" type="primary" @click="goToSellerAdmin">
    ...
    <div v-loading="loading" class="dashboard-content">
      <div v-if="status === 'NotApplied'" class="status-empty">
      ...
      <div v-else-if="status === 'Pending'" class="status-empty">
      ...
      <div v-else-if="status === 'Rejected'" class="status-empty">
        <el-result icon="error" title="申請被駁回" sub-title="很抱歉，您的賣場申請未通過審核。">
          <template #extra>
            <el-button type="primary" @click="router.push('/member/seller-apply')">重新申請</el-button>
          </template>
        </el-result>
      </div>
