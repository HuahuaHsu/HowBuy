...
const currentLevel = computed(() => {
  if (levelRules.value.length === 0) return { levelName: currentLevelName.value || '載入中...', color: '#94a3b8' }
  return levelRules.value.find(l => l.levelName === currentLevelName.value) || levelRules.value[0]
})
